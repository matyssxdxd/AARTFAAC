...
AARTFAAC_Parset::AARTFAAC_Parset(int argc, char **argv)
:
  CorrelatorParset(argc, argv, false),
  _nrRingBufferSamplesPerSubband(3 * 196608 + 256),
...
std::vector<std::string> AARTFAAC_Parset::compileOptions() const
{
