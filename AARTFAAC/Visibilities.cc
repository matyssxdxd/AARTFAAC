...
Visibilities::Visibilities(const AARTFAAC_Parset &ps, unsigned subband)
:
  ps(ps),
  //hostVisibilities(boost::extents[ps.nrOutputChannelsPerSubband()][ps.nrBaselines()][ps.nrVisibilityPolarizations()])
